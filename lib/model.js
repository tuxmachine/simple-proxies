...
ProxyList.prototype.getRandomProxy = function() {
...
var CheckConfig = function () {
  ...
  this.checkPing = false; // ping is experimental, sorry guys !, imply to run the apps as sudo
  this.googleAdress = "https://www.google.com/#q=test";
  this.pingTimeout = 5000;
  this.proxyRequestTimeout = 5000;

  this.setCheckPing = function (value) {
    this.checkPing = value;
    return this;
  }


  this.setPingTimeout = function (value) {
...
/*
 * Default config for loading proxies from a file
 *
 */
